...
RSpec.feature "Group management", type: :feature do
  scenario "User visits the group show page" do
    ...
    item1 = group.items.create(name: 'Item 1', amount: 100, authors_id: user.id, group_id: group.id)
    item2 = group.items.create(name: 'Item 2', amount: 150, authors_id: user.id, group_id: group.id)
